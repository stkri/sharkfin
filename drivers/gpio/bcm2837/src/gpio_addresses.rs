...
pub const GPIO_FUNCTION_SELECT_0: *mut u32 = 0x3F20_0000 as *mut u32;
...
///
/// For more info on each mode, check the corresponding GPIO type.
pub const GPIO_FUNCTION_SELECT_1: *mut u32 = 0x3F20_0004 as *mut u32;
...
///
/// For more info on each mode, check the corresponding GPIO type.
pub const GPIO_FUNCTION_SELECT_2: *mut u32 = 0x3F20_0008 as *mut u32;
...
///
/// For more info on each mode, check the corresponding GPIO type.
pub const GPIO_FUNCTION_SELECT_3: *mut u32 = 0x3F20_000C as *mut u32;
...
///
/// For more info on each mode, check the corresponding GPIO type.
pub const GPIO_FUNCTION_SELECT_4: *mut u32 = 0x3F20_0010 as *mut u32;
...
///
/// For more info on each mode, check the corresponding GPIO type.
pub const GPIO_FUNCTION_SELECT_5: *mut u32 = 0x3F20_0014 as *mut u32;

/// Set high voltage for pins 0 through 31.
/// To set a pin high, set the bit `pin` to 1.
/// All 0s are ignored
pub const GPIO_SET_HIGH_0: *mut u32 = 0x3F20_001C as *mut u32;

/// Set high voltage for pins 32 through 53.
/// To set a pin high, set the bit `pin - 32` to 1.
/// All 0s are ignored
pub const GPIO_SET_HIGH_1: *mut u32 = 0x3F20_0020 as *mut u32;

/// Set low voltage for pins 0 through 31.
/// To set a pin high, set the bit `pin` to 1.
/// All 0s are ignored
pub const GPIO_SET_LOW_0: *mut u32 = 0x3F20_0028 as *mut u32;

/// Set low voltage for pins 32 through 53.
/// To set a pin high, set the bit `pin - 32` to 1.
/// All 0s are ignored
pub const GPIO_SET_LOW_1: *mut u32 = 0x3F20_002C as *mut u32;

/// Get the voltage levels for pins 0 through 31.
/// Each bit represents a pin, with 1 being high and 0 being low.
pub const GPIO_GET_LEVEL_0: *mut u32 = 0x3F20_0034 as *mut u32;

/// Get the voltage levels for pins 32 through 53.
/// Each bit represents a pin, with 1 being high and 0 being low.
pub const GPIO_GET_LEVEL_1: *mut u32 = 0x3F20_0038 as *mut u32;
...
pub const GPIO_PIN_SET_PULL: *mut u32 = 0x3F20_0094 as *mut u32;
...
/// 5. Clear GPIO_PIN_SET_PULL
/// 6. Clear GPIO_PIN_SET_PULL_CLOCK_*
pub const GPIO_PIN_SET_PULL_CLOCK_0: *mut u32 = 0x3F20_0098 as *mut u32;
...
/// 5. Clear GPIO_PIN_SET_PULL
/// 6. Clear GPIO_PIN_SET_PULL_CLOCK_*
pub const GPIO_PIN_SET_PULL_CLOCK_1: *mut u32 = 0x3F20_009C as *mut u32;
